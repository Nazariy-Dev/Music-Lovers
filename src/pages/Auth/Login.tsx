...
export default function Login() {
    ...
    const { register, handleSubmit, formState: { errors, isSubmitted } } = useForm<FormFields>({ resolver: zodResolver(schema) })
                ...
                <div className='max-w-[400px] w-full'>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className='flex flex-col gap-4'>
                            ...
                            {isSubmitted && <div className='mt-2 text-error'>{error ? error.message : ''}</div>}
